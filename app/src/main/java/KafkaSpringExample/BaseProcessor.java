 ...
 *
 * @author MC03353
 * Base processor, responsible for defining stream configuration
 */
public abstract class BaseProcessor {s
    ...
    @Bean
    public KafkaTemplate<Integer, Integer> processorProducerFactory(){
